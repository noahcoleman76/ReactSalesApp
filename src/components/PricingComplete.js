...
// ]
// window.localStorage.setItem("pricingCallCompleted", JSON.stringify(pricingCallCompleted))

const localStorageDataName = "pricingCallCompleted"
const localStorageDataPull = JSON.parse(localStorage.getItem("pricingCallCompleted"))
